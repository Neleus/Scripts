#!/bin/sh
## OS: "ubuntu2004","ubuntu2204","ubuntu2404"

#
# metadata_begin
# recipe: Teamspeak
# tags: centos,debian,ubuntu1604,ubuntu1804,ubuntu2004,ubuntu2204
# revision: 14
...
if [ "${OSNAME}" = "debian" ]; then
	...
	case ${release} in
		xenial|stretch|bionic|buster|bullseye|jammy|focal)
